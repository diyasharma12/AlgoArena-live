# Contributing to AlgoArena Live

Thank you for your interest in contributing to AlgoArena Live! We welcome contributions from the community to help make this platform better.
...
2. Clone the repository and install dependencies:
   ```bash
   git clone https://github.com/<your-username>/algoarena-live.git
   cd algoarena-live
   pnpm install
   ```
