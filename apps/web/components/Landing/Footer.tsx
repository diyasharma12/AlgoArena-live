    ...
    <>
        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-6 text-sm relative z-10 font-minecraft">
          ...
          <div className="flex items-center gap-3 group cursor-pointer">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-foreground font-bold tracking-tight">AlgoArena Live</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6 text-muted-foreground h-full">
            ...
            <motion.a
              ...
              href="https://github.com/<your-username>/algoarena-live"
              target="_blank"
      ...
      >
        <div className="space-y-4">
          <p>
            Welcome to <strong className="text-foreground">AlgoArena Live</strong>. By using our platform, you agree to
