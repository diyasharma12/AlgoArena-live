...
const faqs = [
  {
    question: "Is AlgoArena Live free to use?",
    answer: "Yes! AlgoArena Live is completely free for all developers. You can practice solo, challenge friends, and climb the leaderboard without any cost."
  },
  {
